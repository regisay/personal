        ...
        <div class="container">
            <nav class="nav">
                ...
                <ul class="nav-list">
                    ...
                    %> 
                    <li class="nav-item">
                    	<a href="${path}/user/mypageP.do" class="nav-link" ><%=id %>님 환영합니다!</a>
                    </li>
                    <li class="nav-item">
                    	<a href="${path}/user/logout.do" class="nav-link" >로그아웃</a>
                    </li>
                    <%
                    } else {
                    %>
                    <li class="nav-item">
                        <a href="${path}/user/loginpage.do" class="nav-link">로그인</a>
                    <%} %>
                    </li>
                    <li class="nav-item">
