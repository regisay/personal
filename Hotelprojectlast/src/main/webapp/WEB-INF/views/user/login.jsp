...
<html>
	...
	<% String pwchk = (String)session.getAttribute("loginChk"); %>
	<section id="contact">
        <div class="wrap">
            <div class="form-wrap">
            	<br>
                ...
                <form action="${pageContext.request.contextPath}/login/login.do" class="input-group" name="login" id="login" method="POST">
